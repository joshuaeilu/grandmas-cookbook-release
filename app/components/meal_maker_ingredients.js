...
export default function MealMakerIngredients() {
    ...
    return (
        <div className="flex flex-col md:flex-row flex-wrap gap-4 p-4 pt-10 ">
            <div className="w-full md:w-1/3 p-4 pt-10  md:pt-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <h5 className="mb-4 text-2xl font-bold text-center tracking-tight text-gray-900 dark:text-white">Meal Ingredients</h5>
                <form className="w-full mb-4">
                    <div className="relative">
                        <input 
                            type="search" 
                            className="block p-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" 
            ...
            <div className="w-full md:w-2/3 p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <h5 className="mb-4 text-2xl font-bold  text-gray-900 dark:text-white">Meals With Selected Ingredients</h5>
                <div className="flex flex-wrap gap-4 justify-center">
                    {allIngredientMeals.map((meal) => (
                        <div className=" " key={meal.idMeal} onClick={() => handleCardClick(meal.idMeal)}>
                            <MealCard
