    ...
    return (
        <div className="p-3">
            <ul className="flex mt-3 mb-3 flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400 justify-center">
                <li className="me-2">
                    <a href="#" aria-current="page" onClick={(e) => handleClick('checklist', e)} className={useClassName2}>Checklist</a>
                </li>
                <li className="me-2">
                    <a href="#" onClick={(e) => handleClick('summary', e)} className={useClassName1}>Summary</a>
                </li>
            </ul>
            {activeTab === 'summary' && (
                <div>
